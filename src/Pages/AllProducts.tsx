...
// const AllProducts = () => {
//   const { allProducts, getProducts, loading, DaleteProduct, EdidProduct } =
//     useStoreProducts();
...
//     EdidProduct(updatedProduct);
//     getProducts();
//     setA((prevA) => prevA + 1000);
//     setOpenModal(false);
//   };
...
//                     </p>
//                     <p className="text-[12px] md:text-[15px]">
//                       <span className="text-blue-600">ProductPrice-</span> £
//                       {product.price}
//                     </p>
//                     <p className="text-[12px] md:text-[15px]">
//                       <span className="text-blue-600">ProductCategory-</span>{" "}
...
//                         <i className="bx bxs-message-square-edit text-green-500"></i>
//                       </Button>
//                       <Button onClick={() => deleteId(product.id)} color="gray">
//                         <i className="bx bxs-trash text-red-600"></i>
//                       </Button>
//                     </Button.Group>
//                   </div>
